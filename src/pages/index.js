...
export default (() => {
	return <Theme theme={theme}>
		...
		>
			...
			<Image src="https://images.unsplash.com/photo-1605260300160-97b082c200a6?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&w=2000" margin="0px 0px 24px 0px" sm-width="100%" />
			<Text
				as="p"
				font="--lead"
				margin="0px 0 24px 0"
